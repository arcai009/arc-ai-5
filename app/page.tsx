...
export default async function LandingPage() {
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <main>
        <section className="relative flex min-h-[78vh] flex-col items-center justify-center gap-8 overflow-hidden px-6 py-16 text-center">
          <div
            aria-hidden="true"
          ...
          <div className="relative flex flex-col items-center gap-4">
            ...
            <p className="max-w-md text-base text-gray-500 dark:text-gray-400">
              Chat with frontier models and run a coding agent — start right
              here, no setup.
            </p>
          </div>
